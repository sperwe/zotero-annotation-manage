...
pref("__prefsPrefix__.show-relate-tags", true);
pref("__prefsPrefix__.current-collection", true);
...
pref("__prefsPrefix__.show-selected-popup-match-tag", true);
pref(
